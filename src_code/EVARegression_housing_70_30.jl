...
function fit_EVaR_l2_warm_start(X, Y)
    ...
    epsilon=0.001
    # Initial values, we use RLS weights as warm start
    w_0 = [-0.09206451358773896, 0.1254709329883594, -0.031062698421574247, 0.11736815443686957,
    -0.2071829714073228, 0.2606957433313951, 0.0120753091936598, -0.31841638131770095, 0.30403432984645895,
    -0.20443951321603374, -0.21347257662148802, 0.0761642841611432, -0.4489369287274476]
    s_0 = 0.9
