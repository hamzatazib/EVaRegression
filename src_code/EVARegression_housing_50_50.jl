...
function fit_EVaR_l2_warm_start(X, Y)
    ...
    epsilon=0.001
    # Initial values, we use RLS weights as warm start
    w_0 = [-0.0874847635742329, 0.11584669107976685, -0.04320872279280865, 0.11899830175790778,
    -0.19000516655162503, 0.26686549239629803, 0.006943883753696587, -0.30021961115213497,
    0.2578951074213603, -0.1619402439619094, -0.20852863268689673, 0.0763891540178019, -0.43795154700687033]
    s_0 = 0.9
