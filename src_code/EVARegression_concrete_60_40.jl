...
function fit_EVaR_l2_warm_start(X, Y)
    ...
    epsilon=0.001
    # Initial values, we use RLS weights as warm start
    w_0 = [0.7428183997024113, 0.5359937946713701, 0.3241967425271084, -0.19296852108837903,
    0.10304860055293483, 0.07742634536876422, 0.10105761211327609, 0.4319990933303235]
    s_0 = 0.9
